...
export { default as HeaderHeightContext } from '@react-navigation/elements/src/Header/HeaderHeightContext';
export { default as HeaderShownContext } from '@react-navigation/elements/src/Header/HeaderShownContext';
export { default as HeaderTitle } from '@react-navigation/elements/src/Header/HeaderTitle';
export { default as useHeaderHeight } from '@react-navigation/elements/src/Header/useHeaderHeight';
export { default as MissingIcon } from '@react-navigation/elements/src/MissingIcon';
...
export const Assets = [
  ...
  // eslint-disable-next-line import/no-commonjs
  require('@react-navigation/elements/src/assets/back-icon-mask.png'),
];

export * from '@react-navigation/elements/src/types';
